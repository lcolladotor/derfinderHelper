...
bibs <- c(knitcitations = citation('knitcitations'),
    ...
    BiocParallel = BibEntry(bibtype = 'unpublished', key = 'BiocParallel', title = 'BiocParallel: Bioconductor facilities for parallel evaluation', author = 'Martin Morgan and Valerie Obenchain and Michel Lang and Ryan Thompson', note = 'R package version 1.5.0', year = '2015'),
    R = citation(),
    IRanges = citation('IRanges'),
    Matrix = citation('Matrix'),
    #S4Vectors = citation('S4Vectors'),
    S4Vectors = BibEntry(bibtype = 'unpublished', key = 'S4Vectors', title = 'S4Vectors: S4 implementation of vectors and lists', author = 'H. Pages and M. Lawrence and P. Aboyoun', note = 'R package version 0.9.6', year = '2015'),
