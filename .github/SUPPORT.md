...
Thank you for using `derfinderHelper`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/derfinderHelper`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/derfinderHelper),
...
[search issues and pull requests](https://github.com/leekgroup/derfinderHelper/issues)
